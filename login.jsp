...
<section class="login py-5 bg-warning">
    <div class="container">
        ...
        <div class="col-lg-6 text-center py-5">
            ...
            <div id="van" style="width: 300px;height: 130px;position: absolute;border-radius: 10px;left:550px;top:10px;
            background-color: rgba(55,255,52,0.55);text-align: center;">
                    ${message}
            </div>
            </c:if>
            <script>
       ...
       <form action="/shopfuniture/login" method="POST">
           <c:if test="${notify!=null}"><div style="color: red;font-size:20px;margin: 0;padding: 0;">${notify}</div></c:if>
           <c:if test="${param.error!=null && sessionScope.notify==null}"><div style="color: red;font-size:20px;margin: 0;padding: 0;">invalid username and password</div></c:if>
...
<button class="btn1 f" type="submit">Login</button>
            ...
            <div class="form-row py-3 pt-4">
                <div class="offset-1 col-lg-10">
                    <a style="padding: 15px 70px 15px 70px ;text-decoration: none;" class="btn1"  href="/shopfuniture/confirm" >New Account++</a>
                </div>
            </div>
           <div  class="form-row py-3 pt-4">
               <div style="display: flex;" class="offset-1 col-lg-10">
                   <a style="margin-left: 100px;" href="/shopfuniture/confirm" >forgot password?</a>
                   <a style="margin-left: 100px;" href="/shopfuniture/reset-pass" >reset password</a>
               </div>
           </div>
       </form>
        </div>
...
<%--    <form action="/spring-mvc/logout" method="post" >--%>
<%--        <input type="submit" value="Logout"  class="inp px-3"/>--%>
<%--    </form>--%>
</section>
