    ...
    <div class="row">
        <div class="col-md-6 welcome_auth">
            <div class="auth_welcome">
                furniture shop bring convenient for purchase ,let visit group page <span><a href="https://www.facebook.com/">fanpage.com</a></span>
            </div>
        </div>
        <div class="col-md-6 login-form">
            <div class="login_form_in">
                <div class="auth_branding">
                    <a class="auth_branding_in" href="/shopfuniture/home-page"><img src="https://res.cloudinary.com/procraftstudio/image/upload/v1613964589/Procraft-Studio-Logo-1_tnfxuj.jpg" alt='Procraft Studio'></a>
                <c:if test="${requestScope.error!=null}"><span style="color: red;">${requestScope.error}</span></c:if>
                </div>
                <h1 class="auth_title text-left">Password Reset</h1>
                <form action="/shopfuniture/user/reset-pass" method="post">
                    ...
                    <div class="form-group other_auth_links">
                        <a class="" href="/shopfuniture/login">Login</a>
                        <a class="" href="/shopfuniture/user/confirm">Register</a>
                    </div>
                </form>
            </div>
        </div>
