...
<head>
  ...
  <link rel="stylesheet" href="<c:url value="/assets/css/lightslider.min.css"/>">
  <!-- font awesome CSS -->
      ...
      <div class="col-lg-7 col-xl-7">
        <div class="product_slider_img">
          <div id="vertical">
            ...
            <div data-thumb="<c:url value="/assets/img/product/single-product/product_1.png"/>">
              <img src="<c:url value="/assets/img/product/single-product/product_1.png"/>" />
            </div>
...
<!-- swiper js -->
<script src="<c:url value="/assets/js/lightslider.min.js" />"></script>
<!-- swiper js -->
...
<script src="<c:url value="/assets/js/swiper.jquery.js" />"></script>
