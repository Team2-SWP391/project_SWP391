            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <c:forEach items="${order}" var="o">
                <tr>
                  ...
                  <th>${o.getStatus()}</th>
                  <th><a href="/shopfuniture/manager/upload?Oid=${o.getOid()}" class="fas fa-edit"></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary" href="/shopfuniture/logout">Logout</a>
      </div>
    </div>
  </div>
</div>
...
<script src="<c:url value="/sale/js/demo/chart-area-demo.js"/>"></script>
