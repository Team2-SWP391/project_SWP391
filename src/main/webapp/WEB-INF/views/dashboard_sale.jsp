...
<script>
  function ConfirmDelete(id) {
    ...
    if (x == true) {
      window.location.href = '/shopfuniture/manager/deleteO?id=' + id
    }
  }
  function action(a){
    window.alert(a)
...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
  <!-- Navbar Brand-->
  <a class="navbar-brand ps-3" href="/shopfuniture/manager/home">Start Bootstrap</a>
  <!-- Sidebar Toggle-->
            ...
            <table id="datatablesSimple">
              ...
              <c:forEach items="${order}" var="o">
                <tr>
                  ...
                  <th><a href="/shopfuniture/manager/upload?Oid=${o.getOid()}" ><span class="fas fa-edit"></span></a>
                    <a href="/shopfuniture/manager/deleteO?Oid=${o.getOid()}" onclick="ConfirmDelete(${o.getOid()})"><span class="fas fa-trash-alt"></span></a>
                  </th>
                </tr>
              </c:forEach>
              </tbody>
...
<script src="<c:url value="/view/assets/demo/chart-area-demo.js"/>"></script>
<script src="<c:url value="/view/assets/demo/chart-bar-demo.js"/>"></script>
