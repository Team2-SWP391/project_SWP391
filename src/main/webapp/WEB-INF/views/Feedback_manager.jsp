              ...
              <c:forEach items="${listF}" var="o">
                <c:if test="${o.getStatus()==1}">
                  <tr>
                    <td>${o.getC_id()}</td>
                    <td>${o.getP_id()}</td>
                    <td style="max-width: fit-content">${o.getDetail()}</td>
                    <td><textarea name="${o.getFid()}" class="form-control" required ></textarea></td>

                    <td>
                      <a href="/shopfuniture/manager/answer_fb?fid=${o.getFid()}"><span class="fas fa-edit"></span></a>
                      <a href="/shopfuniture/manager/delete_fb?fid=${o.getFid()}"><span class="fas fa-trash-alt"></span></a>
                    </td>
                  </tr>
                </c:if>
              </c:forEach>
