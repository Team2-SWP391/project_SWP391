...
<div class="header">
    <div class="container">
        <!-- logo shop HEADER ở đây-->
        <a class="site-logo" href="shop-index.html"><img src="<c:url value="/assets/user/corporate/img/logos/shop-logo-red.png"/>" alt="Furnicom Shop UI"></a>
            ...
            <div class="top-cart-content-wrapper">
                <div class="top-cart-content">
                    <ul class="scroller" style="height: 250px;">
                        <li>
                            <a href="shop-item.html"><img src="<c:url value="/assets/user/pages/img/cart-img.jpg    "/>" alt="Rolex Classic Watch" width="37" height="34"></a>
                            ...
                            <div class="header-navigation-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 nav-brands">
                                        <ul>
                                            <li><a href="shop-product-list.html"><img title="esprit" alt="esprit" src="<c:url value="/assets/user/pages/img/brands/esprit.jpg"/>"></a></li>
                                            <li><a href="shop-product-list.html"><img title="gap" alt="gap" src="<c:url value="/assets/user/pages/img/brands/gap.jpg"/>"></a></li>
                                            <li><a href="shop-product-list.html"><img title="next" alt="next" src="<c:url value="/assets/user/pages/img/brands/next.jpg"/>"></a></li>
                                            <li><a href="shop-product-list.html"><img title="puma" alt="puma" src="<c:url value="/assets/user/pages/img/brands/puma.jpg"/>"></a></li>
                                            <li><a href="shop-product-list.html"><img title="zara" alt="zara" src="<c:url value="/assets/user/pages/img/brands/zara.jpg"/>"></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="header-navigation-content">
                                <div class="row">
                                    <div class="col-md-3 col-sm-4 col-xs-6">
                                        <div class="product-item">
                                            <div class="pi-img-wrapper">
                                                <a href="shop-item.html"><img src="<c:url value="/assets/user/pages/img/products/model4.jpg"/>" class="img-responsive" alt="Berry Lace Dress"></a>
                                            </div>
                                    ...
                                    <div class="col-md-3 col-sm-4 col-xs-6">
                                        <div class="product-item">
                                            <div class="pi-img-wrapper">
                                                <a href="shop-item.html"><img src="<c:url value="/assets/user/pages/img/products/model3.jpg"/>" class="img-responsive" alt="Berry Lace Dress"></a>
                                            </div>
                                            <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
                                            <div class="pi-price">$29.00</div>
                                            <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                                    ...
                                    <div class="col-md-3 col-sm-4 col-xs-6">
                                        <div class="product-item">
                                            <div class="pi-img-wrapper">
                                                <a href="shop-item.html"><img src="<c:url value="/assets/user/pages/img/products/model7.jpg"/>" class="img-responsive" alt="Berry Lace Dress"></a>
                                            </div>
                                            <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
                                            <div class="pi-price">$29.00</div>
                                            <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
